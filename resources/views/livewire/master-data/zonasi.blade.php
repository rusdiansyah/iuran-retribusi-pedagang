...
new #[Layout('layouts.app')] class extends Component {
    ...
    {
        $data = Zonasi::where('nama', 'like', '%' . $this->search . '%')->paginate(10);
        return view('livewire.master-data.zonasi', compact('data'));
    }
    ...
    public function store()
    {
        ...
        $exists = \App\Models\Zonasi::whereRaw('LOWER(nama) = ?', [strtolower(trim($this->nama))])
        ...
        Zonasi::updateOrCreate(['id' => $this->editId], ['nama' => $this->nama]);
...
<div>
        ...
        <table class="w-full text-sm text-left text-gray-500">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3">Nama Zonasi</th>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center overflow-auto bg-black bg-opacity-50">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
            <h3 class="text-lg font-bold mb-4">{{ $editId ? 'Edit' : 'Tambah' }} Zonasi</h3>
            <form wire:submit="store">
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2">Nama Zonasi</label>

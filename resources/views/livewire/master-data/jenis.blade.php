...
new #[Layout('layouts.app')] class extends Component {
    ...
    {
        $data = Jenis::where('nama', 'like', '%' . $this->search . '%')->paginate(10);
        return view('livewire.master-data.jenis', compact('data'));
    }
    ...
    public function store()
    {
        ...
        $exists = \App\Models\Jenis::whereRaw('LOWER(nama) = ?', [strtolower(trim($this->nama))])
        ...
        Jenis::updateOrCreate(['id' => $this->editId], ['nama' => $this->nama]);
...
<div>
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Manajemen Jenis</h2>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center overflow-auto bg-black bg-opacity-50">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
            <h3 class="text-lg font-bold mb-4">{{ $editId ? 'Edit' : 'Tambah' }} Jenis</h3>
            <form wire:submit="store">
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2">Nama Jenis</label>

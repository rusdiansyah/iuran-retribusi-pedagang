...
new #[Layout('layouts.app')] class extends Component {
    ...
    {
        $data = Metode::where('nama', 'like', '%' . $this->search . '%')->paginate(10);
        return view('livewire.master-data.metode', compact('data'));
    }
    ...
    public function store()
    {
        ...
        $exists = \App\Models\Metode::whereRaw('LOWER(nama) = ?', [strtolower(trim($this->nama))])
        ...
        Metode::updateOrCreate(['id' => $this->editId], ['nama' => $this->nama]);
...
<div>
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Manajemen Metode</h2>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center overflow-auto bg-black bg-opacity-50">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
            <h3 class="text-lg font-bold mb-4">{{ $editId ? 'Edit' : 'Tambah' }} Metode</h3>
            <form wire:submit="store">
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2">Nama Metode</label>
